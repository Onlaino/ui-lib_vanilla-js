...
_core_js__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.modal = function (created) {
  for (let i = 0; i < this.length; i++) {
    ...
    (0,_core_js__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(evt => {
      evt.preventDefault();
    ...
    closeElements.forEach(el => {
      (0,_core_js__WEBPACK_IMPORTED_MODULE_0__["default"])(el).click(() => {
...
_core_js__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function ({
  text,
  btns
} = {}) {
  for (let i = 0; i < this.length; i++) {
    ...
    // btns = { count: num, settings: [ [text, classNames=[]], close: boolean, callback ] }
...
/* harmony import */ var _components_dropdown_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/dropdown.js */ "./src/js/lib/components/dropdown.js");
/* harmony import */ var _components_modal_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/modal.js */ "./src/js/lib/components/modal.js");
/* harmony import */ var _components_tabs_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/tabs.js */ "./src/js/lib/components/tabs.js");
/* harmony import */ var _components_accordion_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/accordion.js */ "./src/js/lib/components/accordion.js");
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.rmAttr = function (name) {
  if (!name) {
    throw Error(`Вы не указали ${name} или ${value}`);
  }
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.animateOverTime = function (duration, callback, finallFn) {
  let timeStart;
  function _animateOverTime(time) {
    if (!timeStart) {
      timeStart = time;
    }
    let timeElaplsed = time - timeStart;
    let complection = Math.min(timeElaplsed / duration, 1);
    callback(complection);
    if (timeElaplsed < duration) {
      requestAnimationFrame(_animateOverTime);
    } else {
      if (typeof finallFn === 'function') {
        finallFn();
      }
    }
  }
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#first').on('click', () => {
  (0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('div').eq(0).fadeToggle(800);
});
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => (0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
  ...
  btns: {
    ...
    }], ['Another button', ['btn-warning', 'ml-10'], false, () => console.log('warning')]]
  }
}));
/******/ })()
;
